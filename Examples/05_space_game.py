...
while True:
    ...
    saucer_r = pg.transform.rotate(saucer, math.degrees(angle) - 90)
    ...
    for shot in shots:
        shot_r = pg.transform.rotate(fire, math.degrees(shot[0]) - 90)
        window.blit(shot_r, shot[1])
        

    # 7.3 Draw text on screen
    font = pg.font.SysFont('helveticaneuedeskinterface', 40)   # font from list above  
